...
exports.StoryRunner = void 0;
exports.runStory = runStory;
exports.setOutsideTheme = setOutsideTheme;
const inkjs = __importStar(require("inkjs"));
/***********************************************************
...
class StoryRunner {
    ...
    contentBottomEdgeY() {
        const bottomElement = this.storyContainer.lastElementChild;
    ...
    removeAll(selector) {
        ...
        allElements.forEach(el => { var _a; return (_a = el.parentNode) === null || _a === void 0 ? void 0 : _a.removeChild(el); });
    }
 ...
 ****************************************************************/
function runStory(storyContent) {
